...
const Home = () => (
  <div>
    ...
    <div className="homePage">
      <h1 className='h1' style={{ textAlign: "center", fontFamily: 'fantasy', color: 'blue', fontWeight: 'bold', fontSize: '48px' }}>Welcome to electroScribe</h1>
      <h4 className='h4' style={{ textAlign: "center", color: 'white' }}>The Electronic Medical Record management app of the future!</h4>
    </div>
